  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 text-slate-100">
      ...
      >
        ...
        {error && (
          <div className="mt-4 rounded-lg border border-rose-300/30 bg-rose-500/10 px-4 py-2 text-sm text-rose-200">
            {error}
          </div>
        )}

        {success && (
          <div className="mt-4 rounded-lg border border-emerald-300/30 bg-emerald-500/10 px-4 py-2 text-sm text-emerald-200">
            {success}
          </div>
        )}
        ...
        <form onSubmit={handleSignup} className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-cyan-400 py-2.5 font-medium text-slate-950 transition hover:bg-cyan-300 disabled:opacity-60"
          >
